...
export default function ColorAnalysisPage() {
  ...
  const handleGenerate = async () => {
    if (!imageUrl) return
    await generate(imageUrl, buildPrompt("color-analysis", config))
  }
    ...
    <div className="min-h-screen bg-muted/20">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2">颜色搭配分析</h1>
            <p className="text-muted-foreground">
              智能解析室内照片的色彩构成，生成专业配色分析展板
            </p>
          </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              <Card className="p-6">
                ...
                <UploadZone
                  ...
                  label="上传室内空间照片"
                  hint="建议上传光线充足的室内全景照片"
                />
              </Card>

              <Card className="p-6">
                <h3 className="font-semibold mb-4">生成配置</h3>
                <ColorConfigPanel value={config} onChange={setConfig} />
              </Card>
                ...
                <ResultDisplay
                  ...
                  onDownload={() => {
                    if (resultImage) {
                      ...
                      link.download = `banana-color-${Date.now()}.png`
                      link.target = "_blank"
