...
import { RenderConfigPanel } from "@/components/render/render-config"
...
export default function RenderPage() {
  ...
  const handleGenerate = async () => {
    if (!imageUrl) return
    await generate(imageUrl, buildPrompt("render", config))
  }
    ...
    <div className="min-h-screen bg-muted/20">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2">渲染增强</h1>
            <p className="text-muted-foreground">
              将 SU 截图、草图或低质量效果图转换为写实摄影级室内效果图
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              <Card className="p-6">
                <h3 className="font-semibold mb-4">上传图片</h3>
                <UploadZone
                  value={imageUrl}
                  onChange={(url) => {
                    setImageUrl(url)
              ...
              <Card className="p-6">
                ...
                <RenderConfigPanel value={config} onChange={setConfig} />
              </Card>
